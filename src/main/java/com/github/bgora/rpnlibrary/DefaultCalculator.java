...
public class DefaultCalculator implements Calculator {
     ...
     */
    public static DefaultCalculator createDefaultCalculator() {
     ...
     * @return Calculator Object.
     */
    public static DefaultCalculator createDefaultCalculator(RoundingMode mode) {
        return new DefaultCalculator(new DefaultChecker(), new DefaultExecutioner(), mode);
    }
     ...
     * @see RPNExecuting
     */
    public static DefaultCalculator createCalculator(RoundingMode mode, RPNChecking checker, RPNExecuting executioner) {
        return new DefaultCalculator(checker, executioner, mode);
    }
     ...
     */
    protected DefaultCalculator(RPNChecking checker, RPNExecuting executioner, RoundingMode mode) {
